...
bool ImGui_ImplGlfwGL3_CreateDeviceObjects()
{
    ...
    g_ShaderHandle = quasi_game_engine::LoadShaders(shaders);
    ...
    int temp_id;
    renderManager->LoadImage(pixels, width, height, false, &temp_id);
    g_FontTexture = temp_id;
                               ...
                               Logger logger, const char* glsl_version)
{
   ...
   uiRenderConfig = new OpenGLRenderConfig(logger, RC_IMGUI);
...
void ImGui_ImplGlfwGL3_NewFrame()
{
    ...
    //TODO: I will handle this mapping elsewhere. It should also be a one off mapping
